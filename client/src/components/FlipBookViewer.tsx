...
export default function FlipBookViewer({ book, onClose, onPayment }: FlipBookViewerProps) {
  ...
  const nextPage = () => {
    if (currentPage < previewPages) {
      ...
      // Trigger payment when trying to access page 4
      onPayment();
    }
  };
    ...
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl w-full max-h-[90vh] overflow-hidden">
        <DialogHeader className="flex flex-row items-center justify-between p-6 border-b">
          <DialogTitle className="text-2xl font-bold text-gray-900">{book.title} - Preview</DialogTitle>
        ...
        <Alert className="mx-6 border-warning bg-warning/10">
        ...
        <div className="p-6">
          <div className="bg-gray-100 rounded-lg p-8 text-center min-h-[500px] flex items-center justify-center">
            <div className="text-gray-500">
              ...
              <p className="mb-6">
                Page <span className="font-bold">{currentPage}</span> of <span className="font-bold">{previewPages}</span> (Preview)
              </p>
              <div className="flex justify-center space-x-4">
                ...
                <Button 
                  ...
                  className="flex items-center space-x-2"
                >
                  <span>{currentPage < previewPages ? 'Next' : 'Unlock Full Book'}</span>
        ...
        <div className="border-t p-6 bg-gray-50">
          <div className="flex flex-col sm:flex-row items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Purchase this book for full access and download.</p>
            </div>
