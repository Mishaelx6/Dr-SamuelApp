...
export default function VideoCard({ video }) {
    ...
    return (<Card className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden">
      <div className="relative">
        <img src={video.thumbnail || "https://images.unsplash.com/photo-1556761175-4b46a572b786?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=300"} alt={`${video.title} thumbnail`} className="w-full h-48 object-cover"/>
      ...
      <CardContent className="p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button onClick={handleWatchVideo} className="flex items-center space-x-2">
