...
export default function AuthorSection() {
    ...
    return (<section id="author" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <img src="./pick2.jpg" alt="Professional author portrait" className="rounded-2xl shadow-xl w-full h-auto"/>
          </div>
          <div>
...
development.
            ...
            <div className="mb-8">
              ...
              <div className="flex space-x-4">
                {socialLinks.map(({ icon: Icon, href, color, platform }) => (<a key={platform} href={href} className={`text-white p-3 rounded-lg transition-colors ${color}`} aria-label={`Follow on ${platform}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button onClick={() => scrollToSection('books')} className="bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-600 transition-colors">
                Browse Books
              </Button>
              <Button onClick={() => scrollToSection('videos')} variant="outline" className="border-2 border-primary text-primary px-6 py-3 rounded-lg font-semibold hover:bg-primary hover:text-white transition-colors">
                Watch Videos
              </Button>
            </div>
          </div>
