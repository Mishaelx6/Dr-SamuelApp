        ...
        <Tabs defaultValue="books" className="space-y-6">
              ...
              {books.map((book) => (<Card key={book.id}>
                  <CardContent className="flex items-center justify-between p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {book.featured && (<Badge variant="secondary" className="bg-primary/10 text-primary text-xs">
                              Featured
                            </Badge>)}
                        </div>
                    ...
                    <div className="space-x-2">
                      ...
                      <Button variant="destructive" size="sm" onClick={() => deleteBookMutation.mutate(book.id)} disabled={deleteBookMutation.isPending}>
                        Delete
                      </Button>
                    </div>
                  </CardContent>
          ...
          <TabsContent value="videos" className="space-y-6">
            ...
            <div className="grid gap-4">
              {videos.map((video) => (<Card key={video.id}>
                  <CardContent className="flex items-center justify-between p-6">
                    <div className="flex items-center space-x-4">
                      {video.thumbnail && (<img src={video.thumbnail} alt={video.title} className="w-24 h-16 object-cover rounded"/>)}
                      <div>
                        <div className="flex items-center gap-2">
                          <h3 className="font-semibold">{video.title}</h3>
                          {video.featured && (<Badge variant="secondary" className="bg-primary/10 text-primary text-xs">
                              Featured
                            </Badge>)}
                        </div>
                    ...
                    <div className="space-x-2">
                      ...
                      <Button variant="destructive" size="sm" onClick={() => deleteVideoMutation.mutate(video.id)} disabled={deleteVideoMutation.isPending}>
                        Delete
                      </Button>
                    </div>
                  </CardContent>
          ...
          <TabsContent value="transactions" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                {purchases.length === 0 ? (<p className="text-gray-500 text-center py-8">No transactions yet</p>) : (<div className="overflow-x-auto">
                ...
                return (<tr key={purchase.id} className="border-b hover:bg-gray-50">
                              <td className="p-2">
